 ...
 * @author SHEHARA
 */
public class tourplanner_menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setText("ARRANGE TOUR GUIDE");
        ...
        jButton4.setText("VIEW REQUIRMENT");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        View_requirment_tourplanner go_user_r = new View_requirment_tourplanner ();
        go_user_r.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tourplanner_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new tourplanner_menu().setVisible(true);
        });
    }
